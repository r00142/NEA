...
class TestStructs(unittest.TestCase):
    ...
    def test_basic01(self):
        ...
        self.assertEqual(self.StructMaster.getstructdict()["substruct01"], x)
    ...
    def test_substruct(self):
        ...
        self.assertEqual(self.StructMaster.parse(data, "mainstruct01"),
                         {'mainstruct01': {'int': 22, 'substruct02': [{'int': 524296, 'short': 274, 'long': 16},
    ...
    def test_const(self):
        ...
        self.assertEqual(self.StructMaster.parse(data, "conststruct01"),
                         {'conststruct01': {'constant': 'TMP', 'int': 1, 'short': 2}})
    ...
    def test_arr(self):
        ...
        self.assertEqual(self.StructMaster.parse(data, "arrstruct01"),
                         {'arrstruct01': {'int': 8, 'array': [530, 4130, 33653, 275, 34, 34336, 658, 595]}})
    ...
    def test_parse_basic(self): #all basic types
        ...
        data = b"\x20\x01\x00\x00\x32\x00\x37\x00\x00\x40\x41\x11\x00\x00\x00\x00\x00\x00\x00\x54\x4d\x50"
        # 288 50 7 12.0 17 TMP in hex
        self.assertEqual(self.StructMaster.parse(data, "allstruct01"),
                                                            {'allstruct01': {'int': 288, 'short': 50, 'char': '7',
                                                            'float': (12.0,), 'long': 17, 'const': 'TMP'}})
